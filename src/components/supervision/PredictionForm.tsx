...
export function PredictionForm() {
  ...
  const handleInputChange = (field: keyof PredictionFormData, value: string | boolean) => {
        ...
        <CardHeader>
          <CardTitle className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-purple-800">Prédiction IA - Analyse Prédictive</h2>
              <p className="text-sm text-purple-600 font-normal">Statut Post-Entretien</p>
            </div>
