...
const ManagerQuickActions: React.FC = () => {
  ...
  return (
    <>
      ...
      <CreateInterventionModal isOpen={modals.intervention} onClose={() => closeModal('intervention')} />
      <MaintenanceScheduleModal isOpen={modals.maintenance} onClose={() => closeModal('maintenance')} />
      <TechnicianAssignmentModal isOpen={modals.technician} onClose={() => closeModal('technician')} />
      <ReportGeneratorModal isOpen={modals.report} onClose={() => closeModal('report')} />
      <CreateAlertModal isOpen={modals.alert} onClose={() => closeModal('alert')} />
      <RouteOptimizationModal isOpen={modals.routes} onClose={() => closeModal('routes')} />
    </>
  );
};
